...
//       {/* Grid */}
//       <div className="max-w-6xl mx-auto grid grid-cols-2 gap-6 px-4 sm:gap-10">
...
//                 src={cat.image}
//                 alt={cat.name}
//                 className="w-full h-[260px] sm:h-[420px] object-cover transition-transform duration-500 group-hover:scale-105"
//               />
//             </div>
